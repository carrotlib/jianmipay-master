...
import com.carrotlib.jianmipay.consts.Constant;
import com.carrotlib.jianmipay.consts.RetEnum;
import com.carrotlib.jianmipay.model.domain.BaseParam;
import com.carrotlib.jianmipay.model.domain.RPCBaseParam;
...
public class RPCUtil {
    ...
    public static BaseParam getBaseParam(Map<String, Object> paramMap) {
        ...
        BaseParam baseParam = BeanConvertUtil.map2Bean(paramMap, BaseParam.class);
        paramMap.remove("rpcSourceSysId");
        paramMap.remove("rpcDateTime");
        paramMap.remove("rpcSequenceNo");
        paramMap.remove("rpcSignType");
        paramMap.remove("rpcSign");
        paramMap.remove("bizSequenceNo");
